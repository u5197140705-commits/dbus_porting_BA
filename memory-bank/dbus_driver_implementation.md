# DBus Driver Implementation (`BshDBus2AppLayer.c`)

This document contains the content of `common/prog/dbus/DBal/BshDBus2AppLayer.c`, which implements the sending and repeating of messages in the DBus Application Layer (DBAL). This file is crucial for understanding the core logic of the existing dbus driver.
...
uint8_t DBAL_DBUS_Handler_TxFlags[1] = {0U};
...
static void DbalTransmitCrPost_appLayerConnection(void)
{
    ...
    {
        const struct DBAL_Instance* tempInst = DBALCR_ConInst;
        DBAL_conMsgTxPostRepeatTrigger(DBALCR_ConInst);
        if(tempInst == DBALCR_ConInst)/*Verify that the pointer has not been modified by the DBAL_handleConMsgTxFail function in meantime.*/
        {
