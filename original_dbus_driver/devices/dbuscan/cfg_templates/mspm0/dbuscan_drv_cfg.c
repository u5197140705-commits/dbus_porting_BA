...
{
    .scfg = MSPI_SCFG_DEFAULT,
    .mspi = &MSPI0,
#if defined(MSPM0L1106)
    .sclk = &MDIOA11_MSPI0_SCK_OUT,
    .miso = &MDIOA10_MSPI0_POCI_IN,  // Peripheral Output Controller Input - MISO
    .mosi = &MDIOA18_MSPI0_PICO_OUT, // Peripheral Input Controller Output - MOSI
#else
    .sclk = &MDIOA12_MSPI0_SCK_OUT,
    .miso = &MDIOA10_MSPI0_POCI_IN,  // Peripheral Output Controller Input - MISO
    .mosi = &MDIOA14_MSPI0_PICO_OUT, // Peripheral Input Controller Output - MOSI
#endif
...
const struct MDIO_Channel* DBCDRV_csPin = &MDIOA2;
#endif
