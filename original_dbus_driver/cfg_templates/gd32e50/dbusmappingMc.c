 ...
 *
 *   \brief    GD32E503 specific mapping library for D-Bus-2 data link layer using
...
#if !defined(DBUS2_NO_BREAK_FUNCTIONALITY)
    #include "mcal_channels.h"
#endif

#if defined(DBUS_UART_CHANNEL_3) || defined (DBUS_UART_CHANNEL_4)
    #error "Unsupported UART unit due to missing busy flag (BSY). Please select supported UART<0,1,2,5> unit."
#endif
