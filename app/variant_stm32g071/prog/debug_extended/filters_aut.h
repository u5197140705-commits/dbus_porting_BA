...
#define DBGX_logChar_ERR_SCN_SSB_CBACK_APP(char)                                                              DBGX_logChar_Wrapper(DBGX_SCN_SSB_CBACK_APP, char)
#define DBGX_logChar_WARN_SCN_SSB_CBACK_APP(char)                                                             DBGX_logChar_Wrapper(DBGX_SCN_SSB_CBACK_APP, char)
#define DBGX_logChar_INFO_SCN_SSB_CBACK_APP(char)                                                             DBGX_logChar_Wrapper(DBGX_SCN_SSB_CBACK_APP, char)
#define DBGX_logStr_SCN_SSB_CBACK_APP(string)                                                                 DBGX_logStr_Wrapper(DBGX_SCN_SSB_CBACK_APP, string)
#define DBGX_logStr_ERR_SCN_SSB_CBACK_APP(string)                                                             DBGX_logStr_Wrapper(DBGX_SCN_SSB_CBACK_APP, string)
#define DBGX_logStr_WARN_SCN_SSB_CBACK_APP(string)                                                            DBGX_logStr_Wrapper(DBGX_SCN_SSB_CBACK_APP, string)
#define DBGX_logStr_INFO_SCN_SSB_CBACK_APP(string)                                                            DBGX_logStr_Wrapper(DBGX_SCN_SSB_CBACK_APP, string)
...
#define DBGX_logInt_ERR_SCN_SSB_CBACK_APP(__logIntVar__...)                                                   DBGX_LOG_INT_VARIABLES(DBGX_logInt, DBGX_SCN_SSB_CBACK_APP, __logIntVar__)
#define DBGX_logInt_WARN_SCN_SSB_CBACK_APP(__logIntVar__...)                                                  DBGX_LOG_INT_VARIABLES(DBGX_logInt, DBGX_SCN_SSB_CBACK_APP, __logIntVar__)
#define DBGX_logInt_INFO_SCN_SSB_CBACK_APP(__logIntVar__...)                                                  DBGX_LOG_INT_VARIABLES(DBGX_logInt, DBGX_SCN_SSB_CBACK_APP, __logIntVar__)
...
#define DBGX_logIntArr_ERR_SCN_SSB_CBACK_APP(__logIntArrVar__...)                                             DBGX_LOG_INT_ARR_VARIABLES(DBGX_logIntArr, DBGX_SCN_SSB_CBACK_APP, __logIntArrVar__)
#define DBGX_logIntArr_WARN_SCN_SSB_CBACK_APP(__logIntArrVar__...)                                            DBGX_LOG_INT_ARR_VARIABLES(DBGX_logIntArr, DBGX_SCN_SSB_CBACK_APP, __logIntArrVar__)
#define DBGX_logIntArr_INFO_SCN_SSB_CBACK_APP(__logIntArrVar__...)                                            DBGX_LOG_INT_ARR_VARIABLES(DBGX_logIntArr, DBGX_SCN_SSB_CBACK_APP, __logIntArrVar__)
#define DBGX_logTime_SCN_SSB_CBACK_APP()                                                                      DBGX_logTime_Wrapper(DBGX_SCN_SSB_CBACK_APP)
#define DBGX_logTime_ERR_SCN_SSB_CBACK_APP()                                                                  DBGX_logTime_Wrapper(DBGX_SCN_SSB_CBACK_APP)
#define DBGX_logTime_WARN_SCN_SSB_CBACK_APP()                                                                 DBGX_logTime_Wrapper(DBGX_SCN_SSB_CBACK_APP)
#define DBGX_logTime_INFO_SCN_SSB_CBACK_APP()                                                                 DBGX_logTime_Wrapper(DBGX_SCN_SSB_CBACK_APP)
#define DBGX_logLocat_SCN_SSB_CBACK_APP()                                                                     DBGX_logLocat_Wrapper(DBGX_SCN_SSB_CBACK_APP)
#define DBGX_logLocat_ERR_SCN_SSB_CBACK_APP()                                                                 DBGX_logLocat_Wrapper(DBGX_SCN_SSB_CBACK_APP)
#define DBGX_logLocat_WARN_SCN_SSB_CBACK_APP()                                                                DBGX_logLocat_Wrapper(DBGX_SCN_SSB_CBACK_APP)
#define DBGX_logLocat_INFO_SCN_SSB_CBACK_APP()                                                                DBGX_logLocat_Wrapper(DBGX_SCN_SSB_CBACK_APP)
...
#define DBGX_logStrStr_ERR_SCN_SSB_CBACK_APP(string_a, string_b)                                              DBGX_logStrStr_Wrapper(DBGX_SCN_SSB_CBACK_APP, string_a, string_b)
#define DBGX_logStrStr_WARN_SCN_SSB_CBACK_APP(string_a, string_b)                                             DBGX_logStrStr_Wrapper(DBGX_SCN_SSB_CBACK_APP, string_a, string_b)
#define DBGX_logStrStr_INFO_SCN_SSB_CBACK_APP(string_a, string_b)                                             DBGX_logStrStr_Wrapper(DBGX_SCN_SSB_CBACK_APP, string_a, string_b)
...
#define DBGX_logStrInt_ERR_SCN_SSB_CBACK_APP(string, __logStrIntVar__...)                                     DBGX_LOG_STR_INT_VARIABLES(DBGX_logStrInt, DBGX_SCN_SSB_CBACK_APP, string, __logStrIntVar__)
#define DBGX_logStrInt_WARN_SCN_SSB_CBACK_APP(string, __logStrIntVar__...)                                    DBGX_LOG_STR_INT_VARIABLES(DBGX_logStrInt, DBGX_SCN_SSB_CBACK_APP, string, __logStrIntVar__)
#define DBGX_logStrInt_INFO_SCN_SSB_CBACK_APP(string, __logStrIntVar__...)                                    DBGX_LOG_STR_INT_VARIABLES(DBGX_logStrInt, DBGX_SCN_SSB_CBACK_APP, string, __logStrIntVar__)
...
#define DBGX_logStrIntArr_ERR_SCN_SSB_CBACK_APP(string, __logStrIntArrVar__...)                               DBGX_LOG_STR_INT_ARR_VARIABLES(DBGX_logStrIntArr, DBGX_SCN_SSB_CBACK_APP, string, __logStrIntArrVar__)
#define DBGX_logStrIntArr_WARN_SCN_SSB_CBACK_APP(string, __logStrIntArrVar__...)                              DBGX_LOG_STR_INT_ARR_VARIABLES(DBGX_logStrIntArr, DBGX_SCN_SSB_CBACK_APP, string, __logStrIntArrVar__)
#define DBGX_logStrIntArr_INFO_SCN_SSB_CBACK_APP(string, __logStrIntArrVar__...)                              DBGX_LOG_STR_INT_ARR_VARIABLES(DBGX_logStrIntArr, DBGX_SCN_SSB_CBACK_APP, string, __logStrIntArrVar__)
...
#define DBGX_logStrStrLocat_ERR_SCN_SSB_CBACK_APP(string_a, string_b)                                         DBGX_logStrStrLocat_Wrapper(DBGX_SCN_SSB_CBACK_APP, string_a, string_b)
#define DBGX_logStrStrLocat_WARN_SCN_SSB_CBACK_APP(string_a, string_b)                                        DBGX_logStrStrLocat_Wrapper(DBGX_SCN_SSB_CBACK_APP, string_a, string_b)
#define DBGX_logStrStrLocat_INFO_SCN_SSB_CBACK_APP(string_a, string_b)                                        DBGX_logStrStrLocat_Wrapper(DBGX_SCN_SSB_CBACK_APP, string_a, string_b)
...
#define DBGX_logStrStrLocatFull_ERR_SCN_SSB_CBACK_APP(string_a, string_b)                                     DBGX_logStrStrLocatFull_Wrapper(DBGX_SCN_SSB_CBACK_APP, string_a, string_b)
#define DBGX_logStrStrLocatFull_WARN_SCN_SSB_CBACK_APP(string_a, string_b)                                    DBGX_logStrStrLocatFull_Wrapper(DBGX_SCN_SSB_CBACK_APP, string_a, string_b)
#define DBGX_logStrStrLocatFull_INFO_SCN_SSB_CBACK_APP(string_a, string_b)                                    DBGX_logStrStrLocatFull_Wrapper(DBGX_SCN_SSB_CBACK_APP, string_a, string_b)
...
#define DBGX_logStrIntLocat_ERR_SCN_SSB_CBACK_APP(string, __logStrIntLocatVar__...)                           DBGX_LOG_STR_INT_LOCAT_VARIABLES(DBGX_logStrIntLocat, DBGX_SCN_SSB_CBACK_APP, string, __logStrIntLocatVar__)
#define DBGX_logStrIntLocat_WARN_SCN_SSB_CBACK_APP(string, __logStrIntLocatVar__...)                          DBGX_LOG_STR_INT_LOCAT_VARIABLES(DBGX_logStrIntLocat, DBGX_SCN_SSB_CBACK_APP, string, __logStrIntLocatVar__)
#define DBGX_logStrIntLocat_INFO_SCN_SSB_CBACK_APP(string, __logStrIntLocatVar__...)                          DBGX_LOG_STR_INT_LOCAT_VARIABLES(DBGX_logStrIntLocat, DBGX_SCN_SSB_CBACK_APP, string, __logStrIntLocatVar__)
...
#define DBGX_logStrIntLocatFull_ERR_SCN_SSB_CBACK_APP(string, __logStrIntLocatFullVar__...)                   DBGX_LOG_STR_INT_LOCAT_FULL_VARIABLES(DBGX_logStrIntLocatFull, DBGX_SCN_SSB_CBACK_APP, string, __logStrIntLocatFullVar__)
#define DBGX_logStrIntLocatFull_WARN_SCN_SSB_CBACK_APP(string, __logStrIntLocatFullVar__...)                  DBGX_LOG_STR_INT_LOCAT_FULL_VARIABLES(DBGX_logStrIntLocatFull, DBGX_SCN_SSB_CBACK_APP, string, __logStrIntLocatFullVar__)
#define DBGX_logStrIntLocatFull_INFO_SCN_SSB_CBACK_APP(string, __logStrIntLocatFullVar__...)                  DBGX_LOG_STR_INT_LOCAT_FULL_VARIABLES(DBGX_logStrIntLocatFull, DBGX_SCN_SSB_CBACK_APP, string, __logStrIntLocatFullVar__)
