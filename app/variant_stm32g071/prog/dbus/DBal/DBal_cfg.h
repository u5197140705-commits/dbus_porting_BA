...
/** \file
 *
 *  \brief    User definitions of parameters for DBal
 *
 *  \details  This header provides the values for DBal as macros.
 *
 */
...
// delay between repetition of transmission in case the connection message was not acknowledged, including time for wakeup break
#define DBAL_DBUS_RECOVERY_TIME_MS          320
