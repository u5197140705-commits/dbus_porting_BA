 ...
 *
 *******************************************************************************
 *  PROJECT          STM32G0 HAL PED Framework
 *  COMP_ABBREV      HI2C
 ******************************************************************************/
...
//lint -e765 external symbol 'xx' could be made static [MISRA 2012 Rule 8.7, advisory]
//lint -e714 external symbol 'xx' was defined but not referenced
/******************************************************************************/
/* PROTOTYPES                                                                 */
/******************************************************************************/
...
#define HDIO_vEnablePort_(port) HDIO_vEnablePort##port()
#define HDIO_vEnablePort(port)  HDIO_vEnablePort_(port)

#define HDIO_vSetOpenDrainPushPullPort_(pin, value) HDIO_vSetOpenDrainPushPullPort##pin(value)
#define HDIO_vSetOpenDrainPushPullPort(pin, value)  HDIO_vSetOpenDrainPushPullPort_(pin, value)

#define HDIO_vSetSpeedPort_(pin, value) HDIO_vSetSpeedPort##pin(value)
#define HDIO_vSetSpeedPort(pin, value)  HDIO_vSetSpeedPort_(pin, value)

#define HDIO_vSetPort_(pin, value) HDIO_vSetPort##pin(value)
#define HDIO_vSetPort(pin, value)  HDIO_vSetPort_(pin, value)

#define HDIO_vSetModePort_(pin, value) HDIO_vSetModePort##pin(value)
#define HDIO_vSetModePort(pin, value)  HDIO_vSetModePort_(pin, value)
