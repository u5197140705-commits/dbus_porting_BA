...
{
    /* Cortex-M0+ settable interrupts */
    //NVIC_SetPriority(SVC_IRQn, PRIORITY_HIGH);
    ...
    //NVIC_SetPriority(RTC_TAMP_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(FLASH_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(RCC_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(EXTI0_1_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(EXTI2_3_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(EXTI4_15_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(DMA_Channel1_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(DMA_Channel2_3_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(DMA_Channel4_5_6_7_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(ADC_COMP_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(TIM1_BRK_UP_TRG_COMP_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(TIM1_CC_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(TIM3_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(TIM14_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(TIM16_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(TIM17_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(I2C1_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(I2C2_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(SPI1_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(SPI2_SPI3_IRQn, PRIORITY_LOW);
    ...
    //NVIC_SetPriority(EXTI2_3_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(EXTI4_15_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(USB_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(DMA1_Channel1_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(DMA1_Channel2_3_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(DMA1_Channel4_5_6_7_DMAMUX_DMA2_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(ADC_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(TIM1_BRK_UP_TRG_COMP_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(TIM1_CC_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(TIM3_TIM4_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(TIM6_IRQn, PRIORITY_LOW);
    ...
    //NVIC_SetPriority(TIM17_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(I2C1_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(I2C2_I2C3_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(SPI1_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(SPI2_SPI3_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(USART1_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(USART2_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(USART3_USART4_USART5_USART6_IRQn, PRIORITY_LOW);
#elif defined(STM32G031)
    //NVIC_SetPriority(WWDG_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(PVD_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(RTC_TAMP_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(FLASH_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(RCC_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(EXTI0_1_IRQn, PRIORITY_LOW);
    ...
    //NVIC_SetPriority(USART1_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(USART2_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(USART3_USART4_LPUART1_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(CEC_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(AES_RNG_IRQn, PRIORITY_LOW);
#elif defined(STM32G051)
    //NVIC_SetPriority(WWDG_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(PVD_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(RTC_STAMP_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(FLASH_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(RCC_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(EXTI0_1_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(EXTI2_3_IRQn, PRIORITY_LOW);
    ...
    //NVIC_SetPriority(TIM2_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(TIM3_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(TIM6_DAC_LPTIM1_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(TIM7_LPTIM2_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(TIM14_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(TIM15_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(TIM16_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(TIM17_IRQn, PRIORITY_LOW);
    ...
    //NVIC_SetPriority(EXTI2_3_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(EXTI4_15_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(UCPD1_UCPD2_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(DMA_Channel1_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(DMA_Channel2_3_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(DMA_Channel4_5_6_7_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(ADC_COMP_IRQn, PRIORITY_LOW);
    ...
    //NVIC_SetPriority(RTC_TAMP_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(FLASH_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(RCC_CRS_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(EXTI0_1_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(EXTI2_3_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(EXTI4_15_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(USBPD1_USBPD2_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(DMA1_Channel1_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(DMA1_Channel2_3_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(DMA1_Channel4_5_6_7_DMAMUX_DMA2_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(ADC_COMP_IRQn, PRIORITY_LOW);
    ...
    //NVIC_SetPriority(TIM14_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(TIM15_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(TIM16_FDCAN_IT0_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(TIM17_FDCAN_IT1_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(I2C1_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(I2C2_I2C3_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(SPI1_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(SPI2_SPI3_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(USART1_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(USART2_LPUART2_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(USART3_USART4_USART5_USART6_LPUART1_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(CEC_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(AES_RNG_IRQn, PRIORITY_LOW);
#elif defined(STM32G081)
    //NVIC_SetPriority(WWDG_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(PVD_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(RTC_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(FLASH_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(RCC_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(EXTI0_1_IRQn, PRIORITY_LOW);
    //NVIC_SetPriority(EXTI2_3_IRQn, PRIORITY_LOW);
