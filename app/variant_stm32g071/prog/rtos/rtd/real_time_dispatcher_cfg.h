...
#define ET_PREEMPTION_THRESHOLD_SPIX_MACAW      ET_PRIORITY_ORYX        ///< Event Thread SPIX_MACAWX
#define ET_PREEMPTION_THRESHOLD_VAQUITA         ET_PRIORITY_ORYX        ///< Event Thread VAQUITA
/* Bluetooth Module Threads */
 ...
 *         The Stack Size should be always multiple of 4 like 256x4 = 1024.
 ***************************************************************************************************/
