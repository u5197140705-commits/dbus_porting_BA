...
// Mapping needed for compatibility reasons between STM32G0 subfamilies
#if defined(STM32G071)
  #undef SYSCFG_CFGR1       //lint !e9021 needed use undef for Stm32G071
  #define SYSCFG_CFGR1      SYSCFG_VREFBUF_CFGR1
#endif
...
/* PLL_M calculation */
    ...
    #else
        #pragma error "No valid EXT_CRYSTAL_OSC value defined."
    #endif
#else
    #pragma error "EXT_CRYSTAL_OSC out of boundaries (4-48MHz)."
#endif
...
/* HPRE calculation */
    ...
    #else
        #pragma error "No valid CORE_CLOCK defined."
    #endif
...
#else
    #pragma error "CORE_CLOCK out of boundaries."
#endif
...
#else
    #pragma error "Not able to calculate PLL_R value."
#endif
...
#define DIV    (CORE_CLOCK / PCLOCK)
    ...
    #else
        #pragma error "No valid peripheral clock defined. PCLOCK must be correctly defined."
    #endif
#else
    #pragma error "No valid peripheral clock defined. PCLOCK must be correctly defined."
#endif
