...
#include "rtd/real_time_dispatcher.h"
    ...
    #include "os/rtos_functional_safety.h"
#endif
...
uint8_t RTOS_traceBuffer[RTOS_TRACE_BUFFER_SIZE] __attribute__((aligned (4))); /* Memory used by ThreadX for tracing. Needs the same alignment qualification as the member with the highest alignment qualifications in TX_TRACE_OBJECT_ENTRY. */
#endif
