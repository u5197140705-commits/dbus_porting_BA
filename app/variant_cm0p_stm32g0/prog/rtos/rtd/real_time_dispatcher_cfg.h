...
#define PERIODIC_THREAD_ULTRA_FAST      THREAD_ACTIVATED
...
/***************************************************************************************************
 * CONFIG: RTD MUTEX SERVICE
 * *************************************************************************************************
 * \brief: Priority Inheritance for all the Mutexes are activated.
 *
 ...
 ***************************************************************************************************/
#define RTD_SERVICE_MUTEX_EN     FEATURE_ACTIVATED

/***************************************************************************************************
 * CONFIG: RTD FUTEX SERVICE
 * *************************************************************************************************
 * \brief: Priority Inheritance for all the Futexes are deactivated.
 *
 *         Futex is same as Mutex, only difference is the Priority Inheritance is deactivated.
 * *************************************************************************************************
 * \note:  Priority inheritance deactivation might reduce some System Load.
 ***************************************************************************************************/
#define RTD_SERVICE_FUTEX_EN     FEATURE_DEACTIVATED
