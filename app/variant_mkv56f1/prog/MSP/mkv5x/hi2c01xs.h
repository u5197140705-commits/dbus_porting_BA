 ...
 *
 *******************************************************************************
 *  PROJECT          MKV5x HAL PED Framework
 *  COMP_ABBREV      HI2C
 ******************************************************************************/
 ...
 * 
 *           This function initializes the special features for the port of the HI2C<unit>.
 *           For instance the clock for the port is enabled in this function.
 *
 * \param    none
 * 
 * \return   none
...
/*lint -save -e526 "symbol '...' is not defined"
 * symbols are defined in hi2c01xs.c
 */
