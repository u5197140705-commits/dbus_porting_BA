...
/** \file
 *
 *   \brief    EFR32 specific mapping library for D-Bus-2 data link layer using
...
/* Axivion Disable Style MisraC2012-20.7: "Macro parameter not enclosed in parentheses" - It works correctly */
...
{
    DBM_INT_FUNC(DBUS_HINT_CHANNEL,_vDisableEvent);
}
