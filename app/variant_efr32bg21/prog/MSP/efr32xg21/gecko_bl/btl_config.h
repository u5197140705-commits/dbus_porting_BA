...
#define BOOTLOADER_ENABLE 1            //BSH configured
#define BOOTLOADER_SUPPORT_STORAGE 1   //BSH configured
  ...
  #include "btl_core_s_cfg.h"
    ...
    #include "gecko_bl/btl_core_cfg.h"    //BSH changed
  #endif
#endif
...
#define BTL_UPGRADE_LOCATION_BASE  0xC000UL    //BSH changed
