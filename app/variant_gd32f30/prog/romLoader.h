...
#define MCU_FW_VERSION_NUMBER	12104
#define MCU_FW_VERSION_MAJOR	1
#define MCU_FW_VERSION_MINOR	21
#define MCU_FW_VERSION_REVISION	4
#define FS_COMP_VERSION_NUMBER	20304
#define FS_COMP_VERSION_MAJOR	2
#define FS_COMP_VERSION_MINOR	3
#define FS_COMP_VERSION_REVISION	4
...
#define ROM1_END	UINT32_C(0x8001fff)
#define ROM1_SIZE	UINT32_C(0x2000)
