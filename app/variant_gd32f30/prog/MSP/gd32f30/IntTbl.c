...
void ITBL_setCustomInterruptPriority(void)
{
    ...
    //NVIC_SetPriority(WWDGT_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(LVD_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(TAMPER_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(RTC_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(FMC_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(RCU_CTC_IRQn, PRIORITY_MEDIUM);
    ...
    //NVIC_SetPriority(DMA0_Channel0_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(DMA0_Channel1_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(DMA0_Channel2_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(DMA0_Channel3_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(DMA0_Channel4_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(DMA0_Channel5_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(DMA0_Channel6_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(ADC0_1_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(USBD_HP_CAN0_TX_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(USBD_LP_CAN0_RX0_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(CAN0_RX1_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(CAN0_EWMC_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(EXTI5_9_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(TIMER0_BRK_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(TIMER0_UP_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(TIMER0_TRG_CMT_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(TIMER0_Channel_IRQn, PRIORITY_MEDIUM);
    ...
    //NVIC_SetPriority(I2C0_EV_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(I2C0_ER_IRQn, PRIORITY_MEDIUM);
    ...
    //NVIC_SetPriority(USART0_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(USART1_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(USART2_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(EXTI10_15_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(RTC_Alarm_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(USBD_WKUP_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(TIMER7_BRK_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(TIMER7_UP_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(TIMER7_TRG_CMT_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(TIMER7_Channel_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(ADC2_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(EXMC_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(SDIO_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(TIMER4_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(SPI2_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(UART3_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(UART4_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(TIMER5_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(TIMER6_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(DMA1_Channel0_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(DMA1_Channel1_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(DMA1_Channel2_IRQn, PRIORITY_MEDIUM);
    //NVIC_SetPriority(DMA1_Channel3_Channel4_IRQn, PRIORITY_MEDIUM);
}
