...
static const struct MUART_Channel *DBM_UART_dbusChannel = &DBUS_MUART_PORT;
...
#endif
#ifdef DBUS_MCAL_MAPPING
   tError = (Terror)(MUART_getError(&DBM_UART_dbusHandle));
#else
