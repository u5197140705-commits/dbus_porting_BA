...
SYMBOL_IRQ void LPUART_IRQHandler(void)
{
  #ifdef MCAL_MUART_INCLUDED
...
SYMBOL_IRQ void TIM1_BRK_IRQHandler(void)
{

}

SYMBOL_IRQ void TIM1_UP_IRQHandler(void)
{
  #ifdef MCAL_MTIM_INCLUDED
    MTIM_IRQ_Handler(MTIM1_IRQ_INDEX);
  #endif
    HTIM1_ISR_HandleTimerEvent();
}

SYMBOL_IRQ void TIM1_TRG_COM_IRQHandler(void)
{
...
SYMBOL_IRQ void TIM6_DAC_IRQHandler(void)
{
  #ifdef MCAL_MTIM_INCLUDED
    MTIM_IRQ_Handler(MTIM6_IRQ_INDEX);
  #endif
    //HTIM6_ISR_HandleEvent();
}

SYMBOL_IRQ void TIM7_IRQHandler(void)
{
  #ifdef MCAL_MTIM_INCLUDED
    MTIM_IRQ_Handler(MTIM7_IRQ_INDEX);
  #endif
    //HTIM7_ISR_HandleEvent();
}

SYMBOL_IRQ void TIM8_BRK_TIM12_IRQHandler(void)
{
  #ifdef MCAL_MTIM_INCLUDED
    MTIM_IRQ_Handler(MTIM12_IRQ_INDEX);
  #endif
    //HTIM12_ISR_HandleTimerEvent();
}

SYMBOL_IRQ void TIM8_UP_TIM13_IRQHandler(void)
{
  #ifdef MCAL_MTIM_INCLUDED
    MTIM_IRQ_Handler(MTIM8_IRQ_INDEX);
    MTIM_IRQ_Handler(MTIM13_IRQ_INDEX);
  #endif
    HTIM8_ISR_HandleTimerEvent();
    //HTIM13_ISR_HandleTimerEvent();
}

SYMBOL_IRQ void TIM8_TRG_COM_TIM14_IRQHandler(void)
{
  #ifdef MCAL_MTIM_INCLUDED
    MTIM_IRQ_Handler(MTIM14_IRQ_INDEX);
  #endif
    //HTIM14_ISR_HandleTimerEvent();
}
...
SYMBOL_IRQ void TIM23_IRQHandler(void)
{
  #ifdef MCAL_MTIM_INCLUDED
    MTIM_IRQ_Handler(MTIM23_IRQ_INDEX);
  #endif
    HTIM23_ISR_HandleEvent();
}

SYMBOL_IRQ void TIM24_IRQHandler(void)
{
  #ifdef MCAL_MTIM_INCLUDED
    MTIM_IRQ_Handler(MTIM24_IRQ_INDEX);
  #endif
    //HTIM24_ISR_HandleEvent();
}
