...
{
#if (!defined(BOOTLOADER_VARIANT) && (UART_CHANNEL == 0))
...
{
#if (!defined(BOOTLOADER_VARIANT) && (UART_CHANNEL == 1))
    DBM_UART_vHandleTxEvent();
#endif
}
...
{
#if (!defined(BOOTLOADER_VARIANT) && (UART_CHANNEL == 2))
    DBM_UART_vHandleTxEvent();
#endif
}
...
{
#if (!defined(BOOTLOADER_VARIANT) && (UART_CHANNEL == 3))
    DBM_UART_vHandleTxEvent();
#endif
}
...
{
#if (!defined(BOOTLOADER_VARIANT) && (UART_CHANNEL == 10))
    DBM_UART_vHandleTxEvent();
#endif
}
...
/* Configuration structure for HUART peripherals. For more details see huart.h*/
    ...
    const T_HUART_Config HUART0_atConfig[] =  {{PCLOCK1 /* clock in MHz */, DEFAULT_BAUDRATE /* baudrate in 100 bps */, HUART_PARITY_EVEN, HUART_STOP_BITS_1}};
    const T_HUART_Config HUART1_atConfig[] =  {{PCLOCK  /* clock in MHz */, DEFAULT_BAUDRATE /* baudrate in 100 bps */, HUART_PARITY_EVEN, HUART_STOP_BITS_1}};
    const T_HUART_Config HUART2_atConfig[] =  {{PCLOCK  /* clock in MHz */, DEFAULT_BAUDRATE /* baudrate in 100 bps */, HUART_PARITY_EVEN, HUART_STOP_BITS_1}};
    const T_HUART_Config HUART3_atConfig[] =  {{PCLOCK  /* clock in MHz */, DEFAULT_BAUDRATE /* baudrate in 100 bps */, HUART_PARITY_EVEN, HUART_STOP_BITS_1}};
    ...
    const T_HUART_Config HUART10_atConfig[] = {{PCLOCK   /* clock in MHz */, DEFAULT_BAUDRATE /* baudrate in 100 bps */, HUART_PARITY_EVEN, HUART_STOP_BITS_1}};


#else // this set of configuration is used in both product application and Programmer
    const T_HUART_Config HUART0_atConfig[]  = {{PCLOCK1 /* clock in MHz */, DEFAULT_BAUDRATE /* baudrate in 100 bps */, HUART_PARITY_NONE, HUART_STOP_BITS_1}};
    const T_HUART_Config HUART1_atConfig[]  = {{PCLOCK  /* clock in MHz */, DEFAULT_BAUDRATE /* baudrate in 100 bps */, HUART_PARITY_NONE, HUART_STOP_BITS_1}};
    const T_HUART_Config HUART2_atConfig[]  = {{PCLOCK  /* clock in MHz */, DEFAULT_BAUDRATE /* baudrate in 100 bps */, HUART_PARITY_NONE, HUART_STOP_BITS_1}};
    const T_HUART_Config HUART3_atConfig[]  = {{PCLOCK  /* clock in MHz */, DEFAULT_BAUDRATE /* baudrate in 100 bps */, HUART_PARITY_NONE, HUART_STOP_BITS_1}};
    /* HUART10: pclock must be in the range [3 x baud rate, 4096 x baud rate].
     * If pclock = 80 MHz then allow baud rate is (19 531 - 26 666 666)*/
    const T_HUART_Config HUART10_atConfig[] = {{PCLOCK  /* clock in MHz */, DEFAULT_BAUDRATE /* baudrate in 100 bps */, HUART_PARITY_NONE, HUART_STOP_BITS_1}};
#endif
