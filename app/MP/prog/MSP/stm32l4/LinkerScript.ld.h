...
/******************************************************************************/
/*
    This is a GCC scatter file template for platform stm32L4.
...
{ 
  ...
  ROM_ANCHOR (rx) : ORIGIN = ROOT_REGION+0x10, LENGTH = 0x0C   // 3 vectors
#if ROOT_REGION == ROM1_START
  ROM1 (rx) : ORIGIN = ROOT_REGION + 0x1C, LENGTH = ROM1_SIZE-0x1C
#else
