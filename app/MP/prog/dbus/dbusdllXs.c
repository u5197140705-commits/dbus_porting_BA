...
*/
BOOL DLL_bIsCurrentNode(uchar ucAddress)
{
    return (((uchar)(ucAddress>>NIBBLE_SIZE) == DLL_ucGetMainNodeAddress()) ? TRUE : FALSE);
}


uchar DLL_ucGetStandardUartConfigIndex(void)
{
...
void DLL_vMessageTransmitted_UserCallback(uchar ucNodeAddress, uchar ucAcknowledge, uint16 uiUserCode)
{
    (void)ucNodeAddress;
    (void)ucAcknowledge;
    (void)uiUserCode;
