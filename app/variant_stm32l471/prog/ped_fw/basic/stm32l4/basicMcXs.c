...
#else
    #error "No EXT_CRYSTAL_OSC defined, nor internal MSI and nor HSI16 defined."
#endif
...
/* AHB Prescaler calculation. It will be used divide SYSCLK */
    ...
    #else
        #error "No valid system clock defined. CORE_CLOCK must be correctly defined."
    #endif
...
#else
    #error "No valid core clock defined. CORE_CLOCK must be correctly defined."
#endif
...
/* PLLR calculation,
   PLLCLK (System Clock) = VCO frequency / PLLPDIV*/
    ...
    #else
        #error "No valid core clock defined. BSC_SYSCLK must be correctly defined."
...
/* VCO input frequency = PLL_SRC_CLK / PLLM with 1 <= PLLM <= 8 
   4MHz <= VCO input frequency <=16MHz*/
    ...
    #else
        #error "No valid PLL_SRC_CLK. It must be correctly defined."
    #endif
/* PLLM calculation */
    #define PLL_N  ((BSC_SYSCLK * PLLR_DIV) / (PLL_SRC_CLK / (PLL_M + 1U)))
    #if (PLL_N <= 7U) || (PLL_N >= 86U)
        #error "No valid peripheral clock defined. EXT_CRYSTAL_OSC must be correctly defined."
    #endif
/* PLLQ calculation */
...
#define BSC_PPRE_DIV1 (CORE_CLOCK / PCLOCK)
    ...
    #else
        #error "No valid value of peripheral clock defined. PCLOCK must be correctly defined."
    #endif
#else
    #error "No valid value of peripheral clock defined. PCLOCK must be correctly defined."
#endif
