...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SEGGER_RTT_PRINTF_BUFFER_SIZE, 512);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GPIO_INIT_PRIORITY, 90);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_KERNEL_INIT_PRIORITY_DEFAULT, 90);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_INTC_INIT_PRIORITY, 90);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DBAL_TX_THREAD_STACK_SIZE, 4096);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DBAL_RX_THREAD_STACK_SIZE, 4096);
